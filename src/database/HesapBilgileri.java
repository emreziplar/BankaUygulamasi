...
public class HesapBilgileri extends DatabaseActions {
    ...
    protected int sifre = 0;
    protected String adSoyad = "", tcNo = "", telNo = "";
    protected String guvenlikSorusu = "", guvenlikCevap = "";
    protected double bakiye = 0, elektrikFaturasi = 0, suFaturasi = 0, dogalgazFaturasi = 0, internetFaturasi = 0;
